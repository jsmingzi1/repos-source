 ...
 * Unicode.
 */
void write_aclip(HWND hwnd, int clipboard, char *, int, bool);
...
bool do_config(void *conf);
bool do_reconfig(HWND, int, void *conf);
 ...
 */
HWND UpdateSizeTip(HWND src, HWND tip_wnd, int cx, int cy);
