 ...
 * that.
 */
GLOBAL int default_protocol; //no impact for below 3 vars
...
extern LogPolicy default_logpolicy[1]; //fun pointers, no impact
 ...
 */
void pgp_fingerprints(HWND hMainWnd);
/*
 ...
 */
//extern bool console_batch_mode, console_antispoof_prompt;//not use, comment it
...
extern int cmdline_tooltype; //this global var can be ignore, no impact
...
unsigned long schedule_timer(HWND hwnd, int ticks, timer_fn_t fn, void *ctx);
