...
namespace ClickActivity {
    ...
    public partial class Activity10 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Activity10).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Activity10));
        ...
        private string FindResource() {
            string[] resources = typeof(Activity10).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Activity10.g.xaml") || resource.Equals("Activity10.g.xaml"))) {
                    return resource;
                }
            }
